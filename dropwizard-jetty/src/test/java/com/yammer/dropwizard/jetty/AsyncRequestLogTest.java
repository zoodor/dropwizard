...
public class AsyncRequestLogTest {
    ...
    private final AsyncRequestLog asyncRequestLog = new AsyncRequestLog(clock,
                                                                        appenders,
    ...
    public void logsRequests() throws Exception {
        ...
        assertThat(event.getFormattedMessage())
                .isEqualTo(
                        "10.0.0.1 - - [16/Nov/2012:05:00:47 +0000] \"GET /test/things?yay HTTP/1.1\" 200 8290 1000 2000");
    ...
    public void logsForwardedFor() throws Exception {
        when(request.getHeader(HttpHeader.X_FORWARDED_FOR.toString())).thenReturn("123.123.123.123");

        final ILoggingEvent event = logAndCapture();
        assertThat(event.getFormattedMessage())
                .isEqualTo(
                        "123.123.123.123 - - [16/Nov/2012:05:00:47 +0000] \"GET /test/things?yay HTTP/1.1\" 200 8290 1000 2000");
    }
    ...
    public void logsPrincipal() throws Exception {
        ...
        assertThat(event.getFormattedMessage())
                .isEqualTo(
                        "10.0.0.1 - coda [16/Nov/2012:05:00:47 +0000] \"GET /test/things?yay HTTP/1.1\" 200 8290 1000 2000");
    }
    ...
    public void logsAsyncContinuations() throws Exception {
        ...
        assertThat(event.getFormattedMessage())
                .isEqualTo(
                        "10.0.0.1 - - [16/Nov/2012:05:00:47 +0000] \"GET /test/things?yay HTTP/1.1\" Async 8290 1000 2000");
    }
