...
public class JadeViewRendererTest extends JerseyTest {
    static {
    ...
    public void returnsA500ForViewsWithBadTemplatePaths() throws Exception {
        try {
            ...
            assertThat(e.getResponse().getEntity(String.class))
                    .isEqualTo("<html><head><title>Missing Template</title></head><body><h1>Missing Template</h1><p>Template /woo-oo-ahh.txt.jade not found.</p></body></html>");
        }
    }
}
