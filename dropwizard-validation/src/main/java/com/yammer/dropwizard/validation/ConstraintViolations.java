...
public class ConstraintViolations {
    ...
    public static <T> ImmutableSet<ConstraintViolation<?>> typeErase(Set<ConstraintViolation<T>> violations) {
    ...
    public static ImmutableList<String> format(Set<ConstraintViolation<?>> violations) {
